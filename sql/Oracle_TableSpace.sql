...
-- 有効化
-- タイプ：永続
CREATE TABLESPACE TS_MAP DATAFILE 'D:\Oracle\19c\oradata\TS_MAP.dbf' SIZE 4G AUTOEXTEND ON NEXT 100M MAXSIZE UNLIMITED EXTENT MANAGEMENT LOCAL ONLINE PERMANENT;
...
-- 有効化
-- タイプ：永続
CREATE TABLESPACE TS_MAPIDX DATAFILE 'D:\Oracle\19c\oradata\TS_MAPIDX.dbf' SIZE 1G AUTOEXTEND ON NEXT 100M MAXSIZE UNLIMITED EXTENT MANAGEMENT LOCAL ONLINE PERMANENT;
